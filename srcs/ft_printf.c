...
/*   Updated: 2017/12/01 20:15:18 by gdannay          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void			fill_content(va_list va, t_flag *tmp)
{
		...
		else if (tmp->length == 3 || tmp->inttype == 6)
...
/*int		main()
{
	printf("\n%d", ft_printf("%lX", 4294967296));
	printf("\n");
	printf("\n%d", printf("%lX", 4294967296));
}*/
